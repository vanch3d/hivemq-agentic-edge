# OpenAPI Specification — Full Review

**File:** `.docs/openapi-bundle.yaml`
**Version:** OpenAPI 3.0.1 — HiveMQ Edge REST API 2025.19-SNAPSHOT
**Stats:** 8443 lines, ~105 operations across 49 paths, ~120 component schemas, 4 shared parameters
...
## Part I — Structural & Technical Quality
...
#### 3.1 Schemas with no description at all
...
#### 3.4 Parameters with missing or vacuous descriptions
...
#### 8.3 Inconsistent capitalization in descriptions
...
### 12. DataPolicyValidator.arguments — Opaque Map Hiding Strategy + Schemas Structure
...
### 13. BehaviorPolicyBehavior.arguments — Opaque Map Hiding Per-Model Parameters
...
## Part II — Agentic & Ontological Readiness
...
## Part III — User-Facing Strings Review (en-US Standards)
...
### 28. Summary/Description Conventions
...
## Part V — Recommendations for Agentic Use

### Priority 1 — Create a supplementary domain ontology (work around spec)
