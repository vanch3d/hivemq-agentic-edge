...
**API layer**:
- `src/api/client-config.ts` — manual file, sets `baseURL` from `VITE_API_BASE_URL` env var
- `src/api/*.gen.ts` — auto-generated, do not edit manually. Regenerate with `pnpm api:generate`
- `src/mocks/` — MSW handlers and Zod-based data collections for dev mocking
