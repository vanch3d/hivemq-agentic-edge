    ...
    switch (input.operation) {
      case "addTopicFilter": {
        ...
        return {
          summary: error
            ? undefined
            : `Topic filter "${tf}" added successfully.`,
          data,
      ...
      case "updateTopicFilter": {
        ...
        return {
          summary: error
            ? undefined
            : `Topic filter "${input.resourceId}" updated successfully.`,
          data,
          error: extractApiError(error),
        };
      }
      ...
      case "deleteTopicFilter": {
        ...
        return {
          summary: error
            ? undefined
            : `Topic filter "${input.resourceId}" deleted successfully.`,
      ...
      case "addCombiner": {
        ...
        return {
          summary: error
            ? undefined
            : `Combiner "${cId}" created successfully.`,
          data,
          error: extractApiError(error),
        };
      }
      ...
      case "updateCombiner": {
        ...
        return {
          summary: error
            ? undefined
            : `Combiner "${input.resourceId}" updated successfully.`,
          data,
          error: extractApiError(error),
        };
      }
      ...
      case "deleteCombiner": {
        ...
        return {
          summary: error
            ? undefined
            : `Combiner "${input.resourceId}" deleted successfully.`,
          data: error ? null : { deleted: input.resourceId },
          error: extractApiError(error),
        };
      }
      ...
      case "setIsa95": {
        ...
        return {
          summary: error
            ? undefined
            : "ISA-95 configuration updated successfully.",
          data,
          error: extractApiError(error),
        };
      }
