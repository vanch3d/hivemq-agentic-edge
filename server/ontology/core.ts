/**
 * Core domain ontology — always injected into the system prompt.
 * Covers: system overview, entity catalog, relationships, data flow,
 * status model, authentication, collection patterns, error model, key enums.
 */

export const CORE_ONTOLOGY = `
## System Overview
