/**
 * Adapter ontology module — injected for adapter-related conversations.
 * Covers: JsonNode disambiguation, adapter type ecosystem, tag semantics, form generation.
 */

export const ADAPTERS_ONTOLOGY = `
## Adapter Deep Dive
