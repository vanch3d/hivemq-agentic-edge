/**
 * Data Hub ontology module — injected when conversation touches policies, schemas, or scripts.
 * Covers: function catalog, behavior models/FSMs, validation strategies, transformation scripts,
 * string interpolation, system limits, policy evaluation flow.
 */

export const DATAHUB_ONTOLOGY = `
## Data Hub Deep Dive
